...
func main() {
	...
	mux.HandleFunc("POST /api/posts/{id}/follow", app.WithAuth(app.FollowUserHandler))
	mux.HandleFunc("DELETE /api/posts/{id}/follow", app.WithAuth(app.UnfollowUserHandler))
